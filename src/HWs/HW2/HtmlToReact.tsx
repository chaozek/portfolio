      ...
      <BoxWrapper>
        ...
        <Block>
          ...
          <p>
            ...
            platform-independent language specifically for use on the internet. One of the main
            goals from the start was to create a language that was simple but also powerful.
          </p>
        </Block>
        ...
        <Block>
          ...
          <p>
            After planning to follow an annual publication cycle, ECMAScript has appeared in
            versions 2016, 2017, 2018, 2019, and 2020. The biggest change in this period was the
            introduction of the two keywords async and await, which have contributed to a
            significant simplification of asynchronous programming.
          </p>
        </Block>
      </BoxWrapper>
